...
# ENV VERSION=v11.8.0 NPM_VERSION=6 YARN_VERSION=latest

# For base builds
ENV CONFIG_FLAGS="--fully-static --without-npm" DEL_PKGS="libstdc++" RM_DIRS=/usr/include

RUN apk add --no-cache curl make gcc g++ mongodb-tools mongodb python py-pip linux-headers binutils-gold gnupg libstdc++ && \
